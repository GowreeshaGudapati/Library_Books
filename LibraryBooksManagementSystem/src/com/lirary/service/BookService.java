...
public class BookService {
	public BookService() {
		// Sample book data
		books.put(1002L, new Book(1002L, "Clean Code", "Robert C. Martin", 2008, 3, "B2", "Clean coding principles."));
		books.put(1003L,
				new Book(1003L, "Atomic Habits", "James Clear", 2018, 4, "C1", "A guide to building good habits."));
		books.put(1004L, new Book(1004L, "Java: The Complete Reference", "Herbert Schildt", 2019, 2, "D3",
				"Comprehensive Java programming guide."));
		books.put(1005L, new Book(1005L, "Think and Grow Rich", "Napoleon Hill", 1937, 6, "E4",
	...
	public Book getBook(Long bookId) {
		return books.get(bookId); // assuming `books` is your Map<String, Book>
	}
}
